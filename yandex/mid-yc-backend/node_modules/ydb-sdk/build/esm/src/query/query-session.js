...
class QuerySession extends events_1.default {
    ...
    logger;
    [symbols_1.ctxSymbol];
    [symbols_1.sessionCurrentOperationSymbol];
    [symbols_1.sessionIdSymbol];
    [symbols_1.sessionTxIdSymbol];
    [symbols_1.sessionTxSettingsSymbol];
    [symbols_1.isIdempotentDoLevelSymbol];
    [symbols_1.isIdempotentSymbol];
    [symbols_1.sessionTrailerCallbackSymbol];
    // private fields, available in the methods placed in separated files
    [exports.implSymbol];
    [exports.attachStreamSymbol];
    [exports.apiSymbol];
    ...
    async delete() {
        ...
        await this[exports.attachStreamSymbol]?.cancel();
    ...
    //     return this.delete();
    // }
    [symbols_1.sessionAttachSymbol] = query_session_attach_1.attach;
    ...
    [symbols_1.sessionBeginTransactionSymbol] = query_session_transaction_1.beginTransaction;
    [symbols_1.sessionCommitTransactionSymbol] = query_session_transaction_1.commitTransaction;
    [symbols_1.sessionRollbackTransactionSymbol] = query_session_transaction_1.rollbackTransaction;
    execute = query_session_execute_1.execute;
}
