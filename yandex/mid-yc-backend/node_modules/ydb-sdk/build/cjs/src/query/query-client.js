...
class QueryClient extends events_1.default {
        ...
        return opts.ctx.wrap({
            ...
            return this.retrier.retry(ctx, async (_ctx) => {
                ...
                if (opts.hasOwnProperty('onTrailer')) {
                    session[symbols_1.sessionTrailerCallbackSymbol] = opts.onTrailer;
                }
                let error;
                try {
                    if (opts.txSettings)
                    ...
                    try {
                        ...
                        if (err instanceof errors_1.YdbError) {
                            delete session[symbols_1.sessionTxIdSymbol];
                        }
                        throw err;
                    }
                    ...
                    delete session[symbols_1.sessionTrailerCallbackSymbol];
                    // @ts-ignore
                    if (error && ((_a = error[symbols_2.RetryPolicySymbol]) === null || _a === void 0 ? void 0 : _a.deleteSession)) {
    ...
    doTx(opts) {
        if (!opts.txSettings) {
            opts = Object.assign(Object.assign({}, opts), { txSettings: table_1.AUTO_TX.beginTx });
        }
        return this.do(opts);
    }
}
