...
const newTokenCreator = (config) => {
    if (isOAuth(config)) {
        return () => {
            ...
            console.warn('By the end of 2026 OAuthToken will be discontinued at Yandex Cloud. Please consider to use another credetials provider.');
